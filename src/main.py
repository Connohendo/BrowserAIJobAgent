...
async def apply_to_tech(info: dict, resume_path: str):
	"""
	json format:
	{
	    "first_name": "Connor",
    ...
    - Navigate to https://linkedin.com/jobs/
	- Search for "DevOps Engineer", "Site Reliability Engineer", "Cloud Engineer", "Software Engineer" positions
...
async def main(test_data_path: str, resume_path: str):
	...
	results = await apply_to_tech(mock_info, resume_path=resume_path)
	print('Search Results:', results)


if __name__ == '__main__':
	parser = argparse.ArgumentParser(description='Apply to tech jobs')
